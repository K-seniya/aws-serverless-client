...
const PUBLIC_ENDPOINT = 'http://localhost:3000/api/public';
const PRIVATE_ENDPOINT = 'http://localhost:3000/api/private';
...
document.getElementById('btn-create').addEventListener('click', () => {
  ...
  fetch('http://localhost:3000/products', {
    ...
    .then((data) => {
      ...
      document.getElementById('message').textContent = data.productId + data.name;
    })
    .catch((e) => {
      console.log('error', e);
    });
